/**
 * 一番星の売上と便の**検証スナップショット**の R2 永続化 (Refs #330 PR3)。
 * (**#859 より前は「一番星マッチ率検証結果」と呼んでいた** — その「マッチ率」を出す
 * 月次比較は廃止し、残るのは `/profit/monthly` の**保存済み検証一覧**だけ。)
 *
...
import type { LocationMatchLevel, ProfitEfficiency } from './ichiban'
