 ...
 *
 * 後者は**候補一覧の 3 割弱**に当たる (本番 2026-07 で 1,668 候補中 455 件 = 27.3%)。バッジだけに
 * すると「積地は合っている明細」と「何も合っていない明細」が**同じ「根拠なし」に潰れる** —
 * 候補が 2 件以上ある便 380 本のうち **41 本**が、バッジ一色なのに両側を見れば
 * 見分けが付く状態になる (旧バッジで潰れていたのは 1 本)。**畳んだことを黙らない**ために両側を返し、
