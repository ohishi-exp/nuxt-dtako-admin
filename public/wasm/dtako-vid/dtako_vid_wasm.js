/* @ts-self-types="./dtako_vid_wasm.d.ts" */
...
export class VdfResult {
     ...
     */
    get frontMp4() {
        const ret = wasm.vdfresult_frontMp4(this.__wbg_ptr);
     ...
     */
    get hasFront() {
        const ret = wasm.vdfresult_hasFront(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    get hasRear() {
        const ret = wasm.vdfresult_hasRear(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    get rearMp4() {
        const ret = wasm.vdfresult_rearMp4(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
    ...
    get telemetryJson() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.vdfresult_telemetryJson(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
 ...
 * @returns {VdfResult}
 */
export function parseVdfToMp4(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parseVdfToMp4(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return VdfResult.__wrap(ret[0]);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('dtako_vid_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
