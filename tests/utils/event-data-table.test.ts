...
describe('proposeEventRowRange', () => {
  ...
  it('同日に同じ市町村への積みが複数回ある場合、最も区間が短い (実際の配送レグに対応する) 組を採用する (実運用回帰: #348 確認中に発覚、最初の積みをそのまま使うと無関係な早朝の別レグまで含めて区間が過大になっていた)', () => {
    const rowsWithMultipleLoads = [
      // 早朝、無関係な別レグの積み (同じ市町村から出発、標茶町へは向かわない)
      row('2026/07/01 06:20:34', '2026/07/01 06:51:49', '積み', '北海道釧路市西港1', '北海道釧路市西港1'),
      row('2026/07/01 06:51:49', '2026/07/01 08:42:01', '運転', '北海道釧路市西港1', '北海道河東郡士幌町'),
      row('2026/07/01 08:42:01', '2026/07/01 09:30:28', '降し', '北海道河東郡士幌町', '北海道河東郡士幌町'),
      // 本命: 標茶町向けの積み〜降し
      row('2026/07/01 11:15:12', '2026/07/01 11:51:23', '積み', '北海道釧路市西港2', '北海道釧路市西港2'),
      row('2026/07/01 11:51:23', '2026/07/01 12:54:32', '運転', '北海道釧路市西港1', '北海道川上郡標茶町多和'),
      row('2026/07/01 12:54:32', '2026/07/01 13:35:11', '降し', '北海道川上郡標茶町多和', '北海道川上郡標茶町多和'),
    ]
    const range = proposeEventRowRange(eventHeaders, rowsWithMultipleLoads, '釧路市', '標茶町多和')
    expect(range).toEqual({
