...
| `salary-2026-07.csv` | 給与明細 CSV (同 4 乗務員 + 給与のみの 9999)。dev では給与比較タブの「デモ明細を読み込み」でワンクリック取込。9901 は golden の理論値どおり支払済み / 9903 は残業代が最低賃金理論値割れ / 9904 は【 補助 】単価なし | `tests/utils/salary-compare-fixture.test.ts` |
